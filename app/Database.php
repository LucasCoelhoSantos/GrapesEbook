    ...
    static public function createSchema(): void {
        ...
        */
        ...
        $con->exec("
            ...
            ('O apanhador de acalantos', 'Beatriz Pereira Rodrigues', 'Infantil', 'Livro baseado em uma das histórias vencedoras da Olimpíada da Língua Portuguesa de 2019 na categoria Crônica. A história fala sobre a percepção de uma menina sobre solidão e empatia.', 15),
